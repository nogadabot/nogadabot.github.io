...
* **실행 중**: 지금 돌아가는 작업 상태.
* **감시 목록(Watchlist)**: 관심 있는 컬렉션의 컨트랙트 주소를 넣고 **감시**를 누르면, 앱이 실행 중일 때 공급량 변화를 알려줍니다. 공급량 변화는 민팅 오픈의 증거가 아닙니다.
* **선별 드롭**: 게시된 추천 드롭이 있으면 표시됩니다.

> 💡 앱의 감시 목록과 Telegram 봇의 드롭 감시는 별도입니다. 봇에서 24시간 감시하려면 봇에 따로 등록하세요. 앱 목록은 봇으로 동기화되지 않습니다. → [텔레그램 봇](../telegram/telegram-bot.md)
