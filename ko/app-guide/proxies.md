...
프록시는 당신의 진짜 IP를 가려, 요청이 같은 IP에서 몰려나가는 걸 막아줍니다. **대부분의 일반 민팅엔 필요 없지만**, 지갑이 아주 많거나 웹사이트 기반 작업을 할 때 유용합니다.
...
* **레지덴셜(Residential)**: 실제 가정용 IP. GB 단위 과금, 데이터 남으면 계속 사용. 느린 편. 초보에게 무난.
