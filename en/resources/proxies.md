...
Proxies spread your IP to avoid bot detection and bans. **Most regular mints don't need them**; they help when you have many wallets or do website-based tasks.
...
* **ISP**: faster and more stable. Usually billed per IP per month. Good for reliability-critical tasks like running Discord.
...
* **StatProxies**: [statproxies.com](https://www.statproxies.com), pricier but sturdier, unlimited data.
...
Enter into the Nogada [Proxies] screen in this format:

```
host:port:username:password
```

> ⚠️ Links/pricing change often. If a link is down, search the provider name. Check reputation before buying.
